...
ActiveRecord::Schema.define(version: 2020_11_06_050612) do
  ...
  create_table "assets", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.integer "sqmt", default: 0, null: false
    t.decimal "price", precision: 10, null: false
    t.string "asset_type", default: "", null: false
    t.string "asset_image", default: "", null: false
    t.integer "rooms", default: 0, null: false
    t.integer "floors", default: 0, null: false
    t.boolean "air_cond", default: false, null: false
    t.integer "units", default: 0, null: false
    t.integer "shops", default: 0, null: false
